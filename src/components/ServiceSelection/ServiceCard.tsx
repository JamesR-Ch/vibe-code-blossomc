...
export const ServiceCard = ({
  ...
  return (
    <div
      className={`group relative p-4 sm:p-5 lg:p-6 border-2 rounded-xl cursor-pointer transition-all duration-300 transform hover:scale-[1.02] ${
        isSelected
    ...
    >
      <div className="flex flex-col sm:flex-row items-start justify-between">
        <div className="flex-1 w-full">
          ...
          <p className="text-xs sm:text-sm text-gray-600 mb-3 leading-relaxed line-clamp-2">{service.description}</p>
          <div className="flex items-center">
            ...
            <p className={`text-sm sm:text-base lg:text-lg font-bold transition-colors duration-300 ${
        ...
        <div className="mt-3 sm:mt-0 sm:ml-4 self-start">
          <div className={`w-6 h-6 sm:w-7 sm:h-7 lg:w-8 lg:h-8 rounded-full border-2 flex items-center justify-center transition-all duration-300 transform group-hover:scale-110 ${
            isSelected
